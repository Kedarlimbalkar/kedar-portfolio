...
export const PROJECTS = [
  ...
  },
  {
    ...
    Description:  "A deep learning application using CNNs to detect and classify human emotions from real-time visual data. Trained on labeled facial-expression datasets with augmentation to improve generalization, and deployed through a Streamlit interface for live webcam inference.",
